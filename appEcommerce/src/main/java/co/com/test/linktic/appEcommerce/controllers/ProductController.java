...
public class ProductController {
	...
	@PostMapping("/create")
	public ResponseEntity<ResponseDTO> saveProduct(@RequestBody ProductDTO Product) {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = Constants.CODIGO_422, message = Constants.MESG_422, response = RespErrorMessage.class),
			@ApiResponse(code = Constants.CODIGO_500, message = Constants.MESG_500, response = RespErrorMessage.class) })
	public ResponseEntity<ResponseDTO> update(@RequestBody ProductDTO client) {
		return this.productServiceImpl.updateProduct(client);
	}
